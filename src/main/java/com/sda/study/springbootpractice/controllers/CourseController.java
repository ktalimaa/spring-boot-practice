...
public class CourseController {
    ...
    @PostMapping
    public ResponseEntity<?> createCourse(@RequestBody Course course) throws SchoolNotFoundException {
        try {
            ...
            School school = schoolService.findSchoolById(course.getSchool().getId());
